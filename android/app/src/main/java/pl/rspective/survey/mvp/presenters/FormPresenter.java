...
import pl.rspective.survey.architecture.bus.events.AnswerUpdateEvent;
...
public class FormPresenter implements IFormPresenter {
    ...
    @Inject
    public FormPresenter(Bus bus, ISurveyRepository ISurveyRepository, UserRepository userRepository, SurveyLocalStorage<String> localStorage, LocalPreferences localPreferences) {
        this.bus = bus;
    ...
    public void loadSurvey() {
        subscriptionSurveyLoad = ISurveyRepository.fetchSurvey(!localPreferences.isSurveyLoaded())
    ...
    public void submitSurvey() {
        ...
        subscriptionSurveySubmit = ISurveyRepository.submitSurvey(submitRequest)
